...
const TOOLS: {
  ...
  },
  {
    ...
    description: 'Browse Rutgers NB professors, read AI summaries and student reviews, filter by verdict',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
...
export default async function HomePage() {
  const [popular, hotCourses, recentReviews] = await Promise.all([getPopular(), getHotCourses(), getRecentReviews()])
