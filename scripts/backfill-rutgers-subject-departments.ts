...
const YEAR = '2025'
const TERM = '9'
// New Brunswick only. Pulling NK/CM subject metadata leaks Camden/Newark school
// labels onto New Brunswick departments (see migration 022 which cleaned them up).
const CAMPUSES = ['NB']
